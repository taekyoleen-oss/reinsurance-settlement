...
export default function BrokerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <aside
        className={cn(
          'shrink-0 bg-surface flex flex-col transition-[width,opacity] duration-300 ease-in-out overflow-hidden border-border print:hidden',
        ...
        <div className="w-60 flex flex-col h-full min-w-[15rem]">
          ...
          <nav className="flex-1 overflow-y-auto py-2">
            ...
            <div className="px-3 pb-3 pt-1">
              <ProcessStepIndicator currentStep={getStepFromPathname(pathname)} collapsed={false} />
            </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* Header */}
        <header className="flex items-center justify-between px-6 py-3 border-b border-border bg-surface shrink-0 print:hidden">
