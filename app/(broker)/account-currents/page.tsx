...
import { AccountCurrentsList } from './AccountCurrentsList'
...
export default async function AccountCurrentsPage() {
  const { contracts, counterparties } = await getInitialData()
  return <AccountCurrentsList initialContracts={contracts} initialCounterparties={counterparties} />
}
